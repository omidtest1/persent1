...
try {
    ...
    $requiredFields = ['meeting_id', 'name', 'coordinates', 'fence_type'];
    ...
    if ($fenceId) {
        $response = ['success' => true, 'message' => 'حصار با موفقیت ذخیره شد', 'fence_id' => $fenceId];
    } else {
        throw new Exception('خطا در ذخیره حصار');
    }
} catch (Exception $e) {
